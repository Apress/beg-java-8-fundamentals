...
public class AccessLevelTest2 {
 	public static void main(String[] args) {
		...
		//int a = al.v1; /* A compiler error */
		//int b = al.v2; /* A compiler error */
		//int c = al.v3; /* A compiler error */
		int d = al.v4;  

		System.out.println("d = " + d);

		//al.m1(); /* A compiler error */
		//al.m2(); /* A compiler error */
		//al.m3(); /* A compiler error */
		al.m4(); 

		/* Modify the values of instance variables */
		//al.v2 = 20;  /* A compiler error */
		//al.v3 = 30;  /* A compiler error */
		al.v4 = 40;
